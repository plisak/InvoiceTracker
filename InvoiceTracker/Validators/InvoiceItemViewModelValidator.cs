...
namespace InvoiceTracker.Validators
{
    public class InvoiceItemViewModelValidator : AbstractValidator<InvoiceItemViewModel>
    {
        public InvoiceItemViewModelValidator()
        {
